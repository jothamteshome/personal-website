...
Instead of having every service running on its own EC2 instance, I consolidated everything onto a single t3a.small instance running [Docker Compose](https://github.com/jothamteshome/infra-hub/tree/main/compose/perpetual-app-host).
